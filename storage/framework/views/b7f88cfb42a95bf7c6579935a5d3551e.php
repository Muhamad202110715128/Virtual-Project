<div class="col-lg-4">
    <div class="card">
        <div class="card-title text-center rounded-top">
            <h4><?php echo e($slot); ?></h4>
        </div>
        <div class="card-content text-center">
            <div class="harga">
                <p class="awal">Rp xxx.xxx</p>
            </div>
        ...
        <a href="#" class="submit-btns">Pilih Paket</a>
        <a href="#" class="submit">Lihat Selengkapnya</a>
    </div>                          
</div>
<?php /**PATH C:\xampp\htdocs\VI\resources\views/components/card.blade.php ENDPATH**/ ?>